...
public static class OneListenerExtentions
{
    ...
    public static void SafeInvoke<T1, T2, T3>(this OneListener<T1, T2, T3> invocationTarget, T1 arg1, T2 arg2, T3 arg3)
    {
        if (null != invocationTarget)
        {
            invocationTarget.Invoke(arg1, arg2, arg3);
    ...
    public static void SafeInvoke<T1, T2, T3, T4>(this OneListener<T1, T2, T3, T4> invocationTarget, 
...
{
    public static T SafeInvoke<T>(this Func<T> invocationTarget)
    {
        if (null != invocationTarget)
        {
            return invocationTarget.Invoke();
        }

        return default(T);
    }

    public static T2 SafeInvoke<T1, T2>(this Func<T1, T2> invocationTarget, T1 arg1)
    {
        if (null != invocationTarget)
        {
            return invocationTarget.Invoke(arg1);
        }
